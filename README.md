...
- [ ] **Этап 0** — скелет монорепо, Docker Compose, healthcheck
- [ ] **Этап 1** — backend-ядро: товары, заказы, журнал посадок
- [ ] **Этап 2** — лендинг: каталог, корзина, оформление заказа
- [ ] **Этап 3** — Telegram-бот: уведомления о заказах
- [ ] **Этап 4** — админ-панель: заказы, статусы, посадки
